...
from thrall.tools.shell import powershell as powershell_run
...
_TOOLS: dict = {
    ...
    powershell_run.NAME: powershell_run.execute,
...
_SCHEMAS: dict = {
    ...
    powershell_run.NAME: (powershell_run.DESCRIPTION, powershell_run.PARAMETERS),
